...
=======
        ...
        logger.warning(
            f"Non-critical: Could not enrich HTA with discovery insights: {e}"
        )
        return hta_tree
...
=======
    ...
    try:
        ...
        logger.warning(
            f"Non-critical: Could not track task completion for discovery: {e}"
        )
...
=======
        ...
        logger.warning(
            f"Non-critical: Could not infuse recommendations into snapshot: {e}"
        )
        return snapshot
