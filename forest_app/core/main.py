...
# --- JSONL error logging for structured error logs ---
from forest_app.core.jsonl_error_logger import setup_jsonl_error_logging
setup_jsonl_error_logging(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'error.jsonl')))
...
from forest_app.core.error_handling import app_exception_handler, validation_exception_handler
...
try:
    from forest_app.routers import core, auth, onboarding, users, hta, error_logs
